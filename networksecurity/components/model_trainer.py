...
class ModelTrainer:
    def __init__(self,model_trainer_cofig:ModelTrainerConfig,data_transformation_artifact:DataTransformationArtifact):
        try:
            self.model_trainer_config=model_trainer_cofig
